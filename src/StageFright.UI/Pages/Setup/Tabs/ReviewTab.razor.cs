...
/// Accounts entries — FR-006). The sample-data choice is no longer surfaced here at all
/// (spec 029, FR-014) — it moved entirely to the first-run screen, which precedes this
/// wizard and never shows a review-style summary.</summary>
