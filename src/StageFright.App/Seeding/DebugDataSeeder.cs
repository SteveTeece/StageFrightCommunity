...
public class DebugDataSeeder : IDebugDataSeeder
{
        ...
        CreateMembersAsync(CancellationToken ct)
    {
        ...
        (string Name, string Address, string Phone, string Email, DateTime JoinDate, DateTime DateOfBirth)[] data =
        [
        ...
        foreach (var (name, address, phone, email, joinDate, dateOfBirth) in data)
        {
