...
/// <summary>Backup DTO mirroring the CommitteeOfficeHolderType entity 1:1.</summary>
[ProtoContract]
public class CommitteeOfficeHolderTypeBackupDto
{
    [ProtoMember(1)] public Guid Id { get; set; }
    [ProtoMember(2)] public string Name { get; set; } = string.Empty;
    [ProtoMember(3)] public int DisplayOrder { get; set; }
    [ProtoMember(4)] public bool IsBuiltIn { get; set; }
