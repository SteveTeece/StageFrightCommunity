...
/// <summary>Backup DTO mirroring the AgmAttendanceRecord entity 1:1.</summary>
[ProtoContract]
public class AgmAttendanceRecordBackupDto
{
    [ProtoMember(1)] public Guid Id { get; set; }
    [ProtoMember(2)] public Guid AnnualGeneralMeetingId { get; set; }
