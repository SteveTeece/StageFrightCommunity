...
- [x] SC-004: Add/Edit Member with two fields takes no longer than the prior single-field flow (spot-check via manual timing, no added required steps) — verified T061: Add Member form shows First Name/Last Name as adjacent fields with no extra steps versus a single Name field; Edit Member pre-populates both independently
