...
- [ ] **T030** [US2] Report-label tests (`ReportsResource` resolves report names/headers/section+total labels — FR-006) and a plugin-under-non-`en` test asserting `StageFright.TestPlugin` English strings render without error or blanking (FR-020) · `tests/StageFright.Reports.Tests/`, `tests/StageFright.Integration.Tests/`
...
- [ ] **T031** [P] [US2] Dashboard page + tiles · `src/StageFright.UI/Resources/Strings/DashboardResource.resx`, `src/StageFright.UI/Pages/Dashboard/**`, `src/StageFright.UI/Modules/*/*Tile.razor(.cs)`
- [ ] **T032** [P] [US2] Rehearsals module · `src/StageFright.UI/Resources/Strings/RehearsalsResource.resx`, `src/StageFright.UI/Pages/Rehearsals/**`
...
- [ ] **T037** [P] [US2] Shared components + remaining cross-cutting text · `src/StageFright.UI/Resources/Strings/SharedResource.resx`, `src/StageFright.UI/Shared/*.razor(.cs)`
- [ ] **T038** [P] [US2] Remaining `*MenuItemProvider` `Title`/`ShortLabel` · `src/StageFright.Core/Modules/Localization/Resources/NavigationResource.resx`, `src/StageFright.Core/Modules/*/*MenuItemProvider.cs`
- [ ] **T039** [P] [US2] Report providers — `ReportName`, filter labels, section labels; filter **option values** stay invariant tokens, **labels** via `EnumsResource` / `Reports_Filter_OptionAll` · `src/StageFright.Reports/Resources/ReportsResource.resx`, `src/StageFright.Reports/Providers/*ReportProvider.cs`
